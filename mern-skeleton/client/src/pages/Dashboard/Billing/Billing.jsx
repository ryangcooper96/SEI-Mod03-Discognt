...
{state.paymentMethod !== 'paypal' ? 
                  (<div className='creditcard-wrapper'><input type='text' placeholder='Name on card' value={state.nameOnCard} onChange={handleChange} name='nameOnCard'></input>
                      <input className='billingElement' type='text' placeholder='card number' value={state.cardNumber} onChange={handleChange} name='cardNumber'></input>
                      <input type='text' className='billingElement'  placeholder='security code' value={state.securityCode} onChange={handleChange} name='securityCode'></input>
                      <input type='text' className='billingElement'  placeholder='billing address line 1' value={state.address1} onChange={handleChange} name='address1'></input>
                      <input type='text' className='billingElement' placeholder='billing address line 2' value={state.address2} onChange={handleChange} name='address2'></input>
